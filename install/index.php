...
define('DEDEDATA',dirname(__FILE__).'/../qm_data');
...
else if($step==4)
{
    ...
    @chmod(DEDEDATA,0777);
    $fp = fopen(DEDEDATA."/common.inc.php","w") or die("<script>alert('写入配置失败，请检查../qm_data目录是否可写入！');history.go(-1);</script>");
...
{
	require_once('../qm_data/admin/config_update.php');
