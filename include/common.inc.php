...
define('DEDEDATA', DEDEROOT.'/qm_data');
define('DEDEMEMBER', DEDEROOT.'/qm_user');
...
//上传的软件目录
$cfg_soft_dir = $cfg_medias_dir.'/download';
...
$cfg_softname = '站窝窝网络';
$cfg_soft_enname = 'QIMAWEB';
$cfg_soft_devteam = '站窝窝网络技术团队';
