...
class SearchView
{
        ...
        for($i=0;$i<$row;$i++)
        {
            ...
            for($j=0;$j<$col;$j++)
            {
                ...
                if($row = $this->dsql->GetArray("al"))
                {
                    ...
                    //处理一些特殊字段
					$row["needmoney"] = Search_addfields($row["id"],"needmoney");
   ...
   /**
    ...
    function GetPageListDM($list_len)
    {
        ...
        $infos = "<span class=\"jumppage total-page\">共".$this->TotalResult."条/显示{$totalpage}页 </span>\r\n";
        ...
        if($this->PageNo != 1)
        {
            ...
            //$indexpage="<a class=\"page-numbers\" href='".$purl."PageNo=1'>首页</a>\r\n";
        }
        else
        {
