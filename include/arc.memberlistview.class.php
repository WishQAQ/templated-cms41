...
class MemberListview
{
 ...
 $countQuery = preg_replace("#ORDER[ \r\n\t]{1,}BY(.*)#is", '', $countQuery);
    ...
    function GetPageList($atts,$refObj='',$fields=array())
    {
        ...
        {
            return "<span class='jumppage go-page' id='go-page' style='display:none;'>";
        }
        if($this->totalResult == 0)
        {
            return '<div class="not-found textc">Ta 还没发布任何内容。</div><span class="jumppage go-page" id="go-page" style="display:none;">';
        }
        $infos = "<span class='jumppage total-page'>共 <span id='max-page'>{$totalpage}</span> 页</span><span class='jumppage go-page' id='go-page'>";
        if($this->totalResult!=0)
        {
        ...
        if($this->pageNO!=1)
        {
            $prepage.="<a class='prev page-numbers' href='".$purl."pageno=$prepagenum'><i class='fa fa-chevron-left'></i></a>\r\n";
        ...
        if($this->pageNO!=$totalpage&&$totalpage>1)
        {
            ...
            $nextpage.="<a class='next page-numbers' href='".$purl."pageno=$nextpagenum'><i class='fa fa-chevron-right'></i></a>\r\n";
        }
        else
        {
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<a class='page-numbers' href='".$purl."pageno=$j'>".$j."</a>\r\n";
            }
        }
